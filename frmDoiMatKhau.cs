...
namespace qltv
{
    public partial class frmDoiMatKhau : Form
    {
        ...
        {
            const string query = "SELECT COUNT(*) FROM tblThuThu WHERE TaiKhoanTT = @acc AND MatKhauTT = @pass";
        ...
        {
            const string query = "UPDATE tblThuThu SET MatKhauTT = @newPass WHERE TaiKhoanTT = @acc";
            using (var command = new SqlCommand(query, connection))
            {
